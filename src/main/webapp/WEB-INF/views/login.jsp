...
<link rel="stylesheet" type="text/css"
	href="${staticPath }/static/style/css/login.css?v=${version}" />
<script type="text/javascript"
	src="${staticPath }/static/js/login.js?v=${version}" charset="utf-8"></script>
</head>
	...
	<div
		...
		<form method="post" id="loginform">
			...
			<P style="position: relative; text-align: left;">
				<input class="rememberMe" type="checkbox" name="rememberMe"
					value="1" checked
					style="vertical-align: middle; margin-left: 40px; height: 20px;" />
				记住密码
			</P>
			<div
