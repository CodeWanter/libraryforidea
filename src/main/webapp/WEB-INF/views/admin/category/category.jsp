                ...
                formatter : function(value, row, index) {
                    var str = '';
                        <shiro:hasPermission name="/category/edit">
                            str += $.formatString('<a href="javascript:void(0)" class="category-easyui-linkbutton-edit" data-options="plain:true,iconCls:\'glyphicon-pencil icon-blue\'" onclick="editcategoryFun(\'{0}\');" >编辑</a>', row.id);
                        </shiro:hasPermission>
                        <shiro:hasPermission name="/category/delete">
                            str += '&nbsp;&nbsp;|&nbsp;&nbsp;';
                            str += $.formatString('<a href="javascript:void(0)" class="category-easyui-linkbutton-del" data-options="plain:true,iconCls:\'glyphicon-trash icon-red\'" onclick="deletecategoryFun(\'{0}\');" >删除</a>', row.id);
                        </shiro:hasPermission>
                    return str;
                }
            } ] ],
...
<div class="easyui-layout" data-options="fit:true,border:false">
    ...
    <div id="orgToolbar" style="display: none;">
        <shiro:hasPermission name="/category/add">
            <a onclick="addcategoryFun();" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'glyphicon-plus icon-green'">添加</a>
        </shiro:hasPermission>
    </div>
</div>