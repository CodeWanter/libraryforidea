        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $.each(result, function (i, item) {
                    var html = "";
                    html += '<li class="Z_clearfix"><a  href="${path }/forehead/article/ndetail/' + item.id + '">' + (pageIndex * 10 + i + 1) + '、' + item.title + '</a><span class="time"><i>' + item.createTime.substr(0, 10) + '</i></span></li>';
                    $("#List").append(html);
                });
            },
