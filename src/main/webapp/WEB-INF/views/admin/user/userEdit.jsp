			...
			<table class="grid">
				<tr>
					...
					<td><input name="id" type="hidden" value="${user.id}">
						<input name="loginName" readonly="readonly" type="text"
						placeholder="请输入登录名称" class="easyui-validatebox"
						data-options="required:true" value="${user.loginName}" style="color:Gray"></td>
					<td>姓名</td>
