            ...
            <table>
                <tr>
                    ...
                    <td><input class="easyui-textbox" type="text" name="title"
                               id="title" data-options="required:true" value="${policy.title}"></input></td>
                </tr>

                <tr>
                    <td>内容:</td>
                    <td><br/> <textarea name="kindeditor" id="kindeditor"
                                        class="xt_textarea">${policy.content }</textarea><br/></td>
                </tr>
                <tr>
                    <td>审核:</td>
...
<script>
    ...
    $(function () {
        kedit("kindeditor");
        document.getElementById("isShow").value = "${policy.isShow }";
        $('#policyEditForm').form({
            url: '${path }/policyback/edit',
