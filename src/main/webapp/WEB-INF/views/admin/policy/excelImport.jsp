...
<div style="width: 100%">
    <div style="padding: 10px 20px 10px 20px">
        <form id="importPolicyForm" method="post" enctype="multipart/form-data">
            <table>
                <tr>
                    <td><a href="${staticPath }/static/lsportal/file/lawDemo.xls" style="color: #00b2ff">样例下载</a></td>
                </tr>
                <tr>
...
<script>
    $(function () {
        $('#importPolicyForm').form({
            url: '${path }/policyback/excelUpload',
