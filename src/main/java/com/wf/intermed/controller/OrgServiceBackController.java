...
@Controller
@RequestMapping("/orgService/back")
public class OrgServiceBackController extends BaseController {
	...
	@GetMapping("/list")
    public String list() {
        return "admin/intermedOrg/servicelist";
    }
    ...
    @GetMapping("/create")
    public String add() {
    	return "admin/intermedOrg/servicecreate";
    }
    ...
    public String edit(Model model,long id) {
    	...
    	return "admin/intermedOrg/serviceedit";
    }
    ...
    @ResponseBody
    @RequestMapping("/save")
    public Object save(@Valid OrgService orgService,HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    public Object update(@Valid OrgService orgService,HttpServletRequest request, HttpServletResponse response) throws Exception {
	 ...
	 * @throws Exception 
	 */
    private HashMap<String, String> uploadServiceGuideFile(HttpServletRequest request, HttpServletResponse response) throws Exception {
